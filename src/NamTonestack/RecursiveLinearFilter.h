...
{
class Base : public tonestack_dsp::DSP
{
public:
...
class LevelParams : public tonestack_dsp::Params
{
public:
...
class HighPassParams : public tonestack_dsp::Params
{
public:
...
class LowPassParams : public tonestack_dsp::Params
{
public:
